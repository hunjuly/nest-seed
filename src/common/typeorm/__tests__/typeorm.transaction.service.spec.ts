...
import { Typeorm, createTestingModule } from 'common'
...
describe('TypeormTransactionService', () => {
    ...
    let transactionService: Typeorm.TransactionService
    ...
    beforeEach(async () => {
        ...
        transactionService = await module.resolve(Typeorm.TransactionService)
